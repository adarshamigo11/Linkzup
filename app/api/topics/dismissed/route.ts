...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("🗑️ Dismissing topic:", topicId, "for user:", user._id.toString())
    ...
    console.log("✅ Topic dismissed successfully:", updatedTopic.title)

    return NextResponse.json({
      success: true,
      message: "Topic dismissed successfully",
      topic: updatedTopic,
    })
  } catch (error) {
