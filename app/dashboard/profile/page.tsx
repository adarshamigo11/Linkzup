  ...
  const generateStory = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setGeneratedStory(data.story.generatedStory)
        setGeneratedTopics(data.story.generatedTopics || [])
        toast.success("Unique story and topics generated successfully!")
    ...
    <div className="max-w-7xl mx-auto py-6 px-4">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Create your unique brand story and generate content topics</p>
        </div>
              ...
              {isGeneratingStory && (
                <div className="flex items-center justify-center py-8">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Generating your unique story...</p>
                    <p className="text-xs text-gray-500 mt-1">Creating personalized content with AI</p>
                  </div>
                </div>
              )}
          ...
          {generatedTopics.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Approve topics to add them to your Topic Bank</p>
              </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>Click &quot;Generate Unique Story&quot; to create your personalized story (Base Story + Customization)</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-blue-100 text-blue-600 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
                  3
                </div>
                <p>Review the generated story and 5 related topics</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-blue-100 text-blue-600 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
                  4
